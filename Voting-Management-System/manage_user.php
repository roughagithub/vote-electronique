...
<div class="container-fluid">
	...
	<form action="" id="manage-user">
		...
		<div class="form-group">
			...
			<input type="text" name="nni" id="nni" class="form-control" value="<?php echo isset($meta['nni']) ? $meta['nni']: '' ?>" required>
		</div>
		<div class="form-group">
			<label for="type">Genre</label>
			<select name="genre" id="genre" class="custom-select">
				<option value="M" <?php echo isset($meta['genre']) && $meta['genre'] == 1 ? 'selected': '' ?>>M</option>
				<option value="F" <?php echo isset($meta['genre']) && $meta['genre'] == 2 ? 'selected': '' ?>>F</option>
			</select>
		</div>
		<div class="form-group">
